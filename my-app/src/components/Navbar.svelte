...
<nav class="px-2 sm:px-4 py-2.5 dark:bg-gray-900  w-full   dark:border-gray-600">
    ...
    <div class="flex md:order-2 md:hidden">
        <button type="button" class="text-white navbtn focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Get started</button>
    ...
    <div class="items-center justify-center hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
      <ul class="flex flex-col items-center p-4 mt-4 border border-gray-100 rounded-lg  md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
        <li>
  ...
  <style>
    .navbtn
    {
        background: linear-gradient(180deg, #0F89FF 0%, #2F608F 100%);
        border-radius: 30px;
    }
    .navbg
    {
...
box-shadow: 0px 33px 227px rgba(0, 0, 0, 0.07), 0px 4.13211px 28.4239px rgba(0, 0, 0, 0.035);
border-radius: 210px;
    }
  </style>